    ...
    <>
      <div className='home-page'>
        ...
        <div className="container-fluid">
          <div className="row">
            <div className="hero-section">
              ...
              <div className="horizontal-btn d-none d-md-flex gap-4 justify-content-center  align-items-end w-100 h-100">
                <div className=" col flex-grow-1">
                  <button id='first-btn' className="btn btn-outline-dark btn-lg  type-button p-4 w-100 fw-bold"><span className='p-3' ><FontAwesomeIcon icon={faCalendarCheck} size="2x" /></span>Programare</button>
                </div>
                <div className="col flex-grow-1">
                  <button className="btn btn-lg btn-outline-dark type-button p-4 w-100 fw-bold"><span className='p-3' ><FontAwesomeIcon icon={faFileCircleCheck} size="2x" /></span>Cere o evaluare</button>
                </div>
                <div className="col flex-grow-1">
                  <button className="btn btn-lg btn-outline-dark type-button p-4 w-100 fw-bold"><span className='p-3' ><FontAwesomeIcon icon={faCommentsDollar} size="2x" /></span>Onorarii
                  </button>
                </div>
              </div>
            </div >
            ...
            <div className="vertical-btn d-md-none d-flex flex-column align-items-center mt-3 gap-1">
              <button className="btn btn-outline-dark type-button p-3 w-80 mb-3 btn-sm"><span className='p-3' ><FontAwesomeIcon icon={faCalendarCheck} size="2x" /></span>Solicita o programare</button>
              <button className="btn btn-outline-dark type-button p-3 w-80 mb-3 btn-sm"><span className='p-3' ><FontAwesomeIcon icon={faFileCircleCheck} size="2x" /></span>Cere o evaluare</button>
              <button className="btn btn-outline-dark type-button p-3 w-80 btn-sm"><span className='p-3' ><FontAwesomeIcon icon={faCommentsDollar} size="2x" /></span>Onorarii</button>
            </div>
        ...
        < section className='problem container mt-4 p-1'>
          <div className="row mt-5 gx-4 flex-column flex-md-row gap-6">
            ...
            <div className="col">
              <div className="services-section ">
                ...
                <div className='services-content container mt-5 p-1'>
                  <h6 className='text-center guide-text fw-bolder' >SERVICII</h6>
